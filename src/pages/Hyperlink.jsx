  ...
  return (
    <div>
      <h5>interactive web animation – 2024</h5>
        ...
        <a href="https://guuseh.github.io/mypersonalhyperlink/" target="_blank" rel="noreferrer">hyperlink//&#10548;&#xFE0E;</a> <sub>(open in Chrome)</sub> is a web-based interactive animation project that explores the intersection of personal identity and digital space in the internet age. Built with React and Framer Motion, the piece combines interactive visuals inspired by early internet aesthetics with a poetic essay that critiques the standardisation and commodification of online presence. It reflects on the personal website as a form of self-expression and quiet resistance against the homogenised templates of modern social media.
        <br/><br/>
